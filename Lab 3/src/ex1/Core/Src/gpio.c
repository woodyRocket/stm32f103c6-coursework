...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SEG1_Pin|SEG2_Pin|V_RED_Pin|V_YEL_Pin
                          |V_GRE_Pin|H_RED_Pin|H_YEL_Pin|H_GRE_Pin
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           ...
                           PBPin PBPin PBPin PBPin */
  GPIO_InitStruct.Pin = SEG1_Pin|SEG2_Pin|V_RED_Pin|V_YEL_Pin
                          |V_GRE_Pin|H_RED_Pin|H_YEL_Pin|H_GRE_Pin
