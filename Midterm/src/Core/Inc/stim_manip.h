...
#define BUTTON_TIMER_HOLD				3000
#define STIM2_TIMER_DELAY				100
#define SUB_BUTTON_TIMER				1000
#define TIM2_TIMER_INTERRUPT 			10

extern STIM_TypeDef* stim2;
extern STIM_TypeDef* rst_stim;
extern STIM_TypeDef* inc_stim;
extern STIM_TypeDef* dec_stim;
extern STIM_TypeDef* subBstim3;
